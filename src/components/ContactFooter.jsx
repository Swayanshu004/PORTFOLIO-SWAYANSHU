...
function ContactFooter() {
  return (
    <div className='w-screen h-[30vh] md:h-[50vh] flex items-end justify-between px-5 '>
        <div>
            <h2 className='text-[8vw] md:text-[10vw] font-[myFont1] text-neutral-700'>swayanshu</h2>
        </div>
        <div className='flex flex-col mb-0 md:mb-10'>
            <Link 
